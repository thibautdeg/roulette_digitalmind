            ...
            <div class="row row-cols-3 g-4">
                <div class="card bg-secondary box-shadow border-0 mt-5">
                    <div class="card-body p-4 d-flex align-items-center justify-content-between">
                        <p><strong>total saldo: {{$data->total}}</strong></p>
                        <p><strong>start bedrag: {{$data->bet}}</strong></p>
                    </div>
                    <div class="card-body p-4">
                        <div class="table-responsive">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-right">{{$game->number}}</p>
                                    </td>
                                    <td>
                                        <p class="text-right">{{$game->bet}}</p>
                                    </td>
                                    <td>
                        ...
                        <div class="d-flex justify-content-between align-items-center w-100">
                            <p class="Red"><strong>red: {{number_format($redper,2)}} %</strong></p>
                            <p><strong>black: {{number_format($blackper,2)}} %</strong></p>
                            <p><strong>personeels kost: {{$hourly}}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
